...
<body class="w3-light-grey">
    ...
    <div class="w3-bar w3-white w3-large">
        ...
        <div class="w3-dropdown-hover w3-hide-small">
            <button class="w3-bar-item w3-button w3-mobile" title="More">Member <i class="fa fa-caret-down"></i></button>
            <div class="w3-dropdown-content w3-bar-block w3-card-4">
                <a href="#" class="w3-bar-item w3-button"> Vĩnh Phong</a>
                <a href="#" class="w3-bar-item w3-button">Phan Cao Vũ</a>
                <a href="#" class="w3-bar-item w3-button">Dương Hồng Ngọc</a>
                <a href="#" class="w3-bar-item w3-button">Ngọc Hân</a>
            </div>
        </div>
    ...
    <div class="w3-content" style="max-width:1532px;">
        ...
        <div class="w3-row-padding" id="about">
            <div class="w3-col l4 12">
                <h3>About</h3>
                <h6>Our hotel is one of a kind. It is truely amazing. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
                    ...
                    anim id est laborum consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</h6>
